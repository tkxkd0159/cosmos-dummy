...
import (
	...
	checkersmodule "jsc/x/checkers"
	checkersmodulekeeper "jsc/x/checkers/keeper"
	checkersmoduletypes "jsc/x/checkers/types"
	jscmodule "jsc/x/jsc"
	jscmodulekeeper "jsc/x/jsc/keeper"
	jscmoduletypes "jsc/x/jsc/types"
...
type App struct {
	*baseapp.BaseApp
	...
	JscKeeper jscmodulekeeper.Keeper
...
func New(
	...
	*/
	...
	app.JscKeeper = *jscmodulekeeper.NewKeeper(
		appCodec,
		keys[jscmoduletypes.StoreKey],
		keys[jscmoduletypes.MemStoreKey],
		app.GetSubspace(jscmoduletypes.ModuleName),
	)
	jscModule := jscmodule.NewAppModule(appCodec, app.JscKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(jscmoduletypes.ModuleName)
